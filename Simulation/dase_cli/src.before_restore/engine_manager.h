...
inline std::string lifecycleStateToString(EngineLifecycleState state) {
    switch (state) {
        case EngineLifecycleState::CREATED: return "CREATED";
        case EngineLifecycleState::INITIALIZED: return "INITIALIZED";
        case EngineLifecycleState::EVOLVED: return "EVOLVED";
...
struct EngineInstance {
    ...
    double gamma;
    double dt;
    EngineLifecycleState lifecycle_state;
    ...
    EngineInstance()
        ...
        , gamma(0.1)
        , dt(0.01)
        , lifecycle_state(EngineLifecycleState::CREATED) {}
};
...
public:
    ...
    std::string createEngine(const std::string& engine_type,
                             ...
                             int N_y = 0,
                             int N_z = 0);
    bool initializeEngine(const std::string& engine_id);
