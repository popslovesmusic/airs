"""
DaseEnginePhase4B.jl - Using Phase 4B optimized DLL
...
"""
module DaseEnginePhase4B

using Printf

# Use Phase 4B optimized DLL
const DASE_LIB = joinpath(@__DIR__, "..", "..", "dase_engine_phase4b.dll")
...
@inline function run_mission_optimized_phase4b!(
    handle::Ptr{Cvoid},
    ...
    ccall((:dase_run_mission_optimized_phase4b, DASE_LIB),
          Cvoid,
...
export create_engine, destroy_engine, run_mission_optimized_phase4b!, get_metrics
