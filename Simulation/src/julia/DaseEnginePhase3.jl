"""
DaseEnginePhase3.jl - Using Phase 3 optimized DLL
"""
module DaseEnginePhase3

using Printf

# Use Phase 3 optimized DLL
const DASE_LIB = joinpath(@__DIR__, "..", "..", "dase_engine_phase3.dll")

# Copy all functions from DaseEngine but with Phase 3 DLL
